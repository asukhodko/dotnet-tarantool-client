...
namespace Tarantool.Client.Extensions
{
    public static class TarantoolClientExtensions
    {
            ...
            CancellationToken cancellationToken = default(CancellationToken))
        {
            try
            {
                await tarantoolClient.CreateSpaceAsync(spaceName, cancellationToken);
            }
        ...
        public static async Task DropSpaceAsync(this ITarantoolClient tarantoolClient, string spaceName,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            await tarantoolClient.EvalAsync($"box.space.{spaceName}:drop()", cancellationToken);
        }
        ...
        public static async Task DropIndexAsync(this ITarantoolClient tarantoolClient, string spaceName,
            string indexName, CancellationToken cancellationToken = default(CancellationToken))
        {
