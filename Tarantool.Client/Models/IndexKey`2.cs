namespace Tarantool.Client.Models
{
    ...
    public class IndexKey<TK1, TK2> : IndexKey
    {
        /// <summary>Initializes a new instance of the <see cref="IndexKey{TK1,TK2}" /> class.</summary>
        /// <param name="keyPart1Value">The key's part 1 value.</param>
        /// <param name="keyPart2Value">The key's part 2 value.</param>
        public IndexKey(TK1 keyPart1Value, TK2 keyPart2Value)
        {
            Key = new object[] { keyPart1Value, keyPart2Value };
        }
    }
}